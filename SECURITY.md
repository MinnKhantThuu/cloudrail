...
The current `0.1.0-alpha.3` development line is the only supported line. No production-readiness guarantee or external security audit is claimed. Check [verification](docs/verification-current.md) and [release gates](docs/release.md) before running a public pilot.
