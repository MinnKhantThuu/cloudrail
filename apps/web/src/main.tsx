...
type Service = { url:string;settings:{kind:string;memoryMB:number;cpuMillis:number;mountPath:string;volumeName:string;network:string};id: string; projectId: string; name: string; environment: string; host: string; activeId: string; desiredState: string; resourceKind:string; workloadMode:string; template:string; cronSchedule:string; cronNextRun?:string; createdAt: string };
