...
- **Current:** Phase 2.4 UX-0 through UX-4 and UX-5.1–UX-5.2 are implemented and verified. UX-5.3 TCP proxy is selected next. UX-9.1–UX-9.2 updated the public Linode to verified commit `c15158a`; the new canvas and resource palette are live at `https://console.172-104-38-63.sslip.io`. User UX acceptance, a new versioned release, GitHub App delivery, certificate renewal and the 48-hour observation remain pending.
