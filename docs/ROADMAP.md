...
| --- | --- |
| Phase 0–3 — flow, workspace, node/jobs | Existing backend/core code ပြီး; Phase 2 UX-0–UX-3 နဲ့ UX-4.1–UX-4.4 data/storage flow ပြီး၊ UX-4.5 database templates next |
